...
├─ features/home/  # the start screen and its components
...
- `@tanstack/react-form`, `@tanstack/zod-form-adapter` and `react-query-kit` are installed but currently unused; they are the intended libraries for forms and query hooks when the first real feature lands.
