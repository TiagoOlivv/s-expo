...
// The Expo account that owns the project. Change it, and EAS_PROJECT_ID below,
// when this template seeds a new app.
const EXPO_ACCOUNT_OWNER = 'tiagoolivv';
// Generated by `eas init`. A dynamic config cannot be written automatically, so
// the id is pasted here by hand - the command prints it and stops.
